...
class AppStateNotifier extends ChangeNotifier {
  ...
  BaseAuthUser? user;
  // Disable splash spinner by default to avoid blocking UI on web.
  ...
  // Only use splash flag; do not block UI when user is null (shows login)
...
FFRoute(
  ...
  builder: (context, params) =>  NewToDoItemWidget(
...
FFRoute(
  ...
  path: '/toDoItemDetails',
  
  
  builder: (context, params) =>  ToDoItemDetailsWidget(
