...
// 確保 LatLng 可用，如果 flutter_flow_util 已經匯出則不需要，但為了保險起見：
...
class _NewToDoItemWidgetState extends State<NewToDoItemWidget> {
  ...
  // NEW: Address Controller & FocusNode
                        ...
                        if (_addressTextController!.text.isNotEmpty) {
                          try {
                            List<geocoding.Location> locations = 
                                await geocoding.locationFromAddress(_addressTextController!.text);
                            ...
                            // Optional: Show snackbar for invalid address
                          }
                        }
