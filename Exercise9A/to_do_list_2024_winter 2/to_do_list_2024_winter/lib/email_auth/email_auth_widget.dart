...
class _EmailAuthWidgetState extends State<EmailAuthWidget> with TickerProviderStateMixin {
...
_model.passwordConfirmFocusNode ??= FocusNode();
      ...
      animationsMap.addAll({          'columnOnPageLoadAnimation1': AnimationInfo(
...
Container(
      ...
      width: double.infinity  ,height: 700.0  ,
      constraints: BoxConstraints( maxWidth: 602.0  ,),
      decoration: BoxDecoration(
        color: FlutterFlowTheme.of(context).secondaryBackground  ,
      ...
      child:           TabBar(
            ...
            labelStyle: FlutterFlowTheme.of(context).displaySmall.override(    fontFamily: 'Outfit',
    ...
    letterSpacing: 0.0,
            ...
            unselectedLabelStyle: FlutterFlowTheme.of(context).displaySmall.override(    fontFamily: 'Outfit',
    ...
    tablet: false,
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          ...
          image: CachedNetworkImageProvider( 'https://images.unsplash.com/photo-1508385082359-f38ae991e8f2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80'  ,),
        ),
